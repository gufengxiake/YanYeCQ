...
public class HKCityBusinessCustomerReportListDataPlugin extends AbstractReportListDataPlugin implements Plugin {
    ...
    public List<AbstractReportColumn> getColumns(List<AbstractReportColumn> columns) throws Throwable {
        ...
        monthjykh.getChildren().add(createReportColumn("",ReportColumn.TYPE_TEXT,"月客户完成率"));
        ...
        yearjykh.getChildren().add(createReportColumn("",ReportColumn.TYPE_TEXT,"交易客户完成"));
        ...
        jpmonthjykh.getChildren().add(createReportColumn("",ReportColumn.TYPE_TEXT,"月度精品客户完成"));
        ...
        jpyearjykh.getChildren().add(createReportColumn("",ReportColumn.TYPE_TEXT,"精品客户完成"));
