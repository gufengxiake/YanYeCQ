...
public class SalOutSaveOperationPlugIn extends AbstractOperationServicePlugIn implements Plugin {
    ...
    public void beginOperationTransaction(BeginOperationTransactionArgs e) {
        ...
        for (DynamicObject dataEntity : dataEntities) {
            Long bizorg = dataEntity.getLong("bizorg");
            Long deliverchannel = dataEntity.getLong("nckd_deliverchannel");
    ...
    public BigDecimal getPurContractPrice(Long org, Long supplierId,Date biztime) {
        QFilter qFilter = new QFilter("validstatus",QCP.equals,"B")
                .and("org", QCP.equals, org)
    ...
    public Long getSupplierId(Long channelId) {
        ...
        DynamicObject bd_bizpartner = QueryServiceHelper.queryOne("bd_bizpartner", "entryentity_supplier.supid as supplierId",
                new QFilter[]{new QFilter("id", QCP.equals, bizpartner)});
        if (bd_bizpartner == null){
            return 0L;
        }
        return bd_bizpartner.getLong("supplierId");
