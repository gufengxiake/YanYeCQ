...
/**
 * HR员工自助移动端-培训经历-弹框
 * 移动动态表单标识：nckd_hspm_emptrainfi_mdg
 * author:chengchaohua
 * date:2024-08-19
 */
public class EmptrainfileMobEditPlugin extends AbstractMobileFormDrawEdit {

    public EmptrainfileMobEditPlugin() {}
    ...
    public void beforeBindData(EventObject eventObject) {
        ...
        this.setValueFromDb(this.getView().getFormShowParameter(), "hrpi_emptrainfile", (String)null);
    ...
    public void click(EventObject evt) {
        ...
        if ("btn_edit".equals(source.getKey())) {
            ...
            if (pkid != null && pkid != 0L) {
                resultMap = this.updateAttachData("hrpi_emptrainfile", this.getView(), false, (String)null);
            } else {
                resultMap = this.addAttachData("0", "hrpi_emptrainfile", this.getView(), this.getModel().getDataEntity(), false);
            }
