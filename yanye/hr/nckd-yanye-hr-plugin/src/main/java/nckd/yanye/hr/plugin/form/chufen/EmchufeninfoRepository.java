...
public class EmchufeninfoRepository {
    // 核心人力云->人员信息->分类维护表单 处分信息表单
    private static final HRBaseServiceHelper SERVICE_HELPER = new HRBaseServiceHelper("nckd_hspm_chufeninfo");
    // HR中台服务云->员工信息中心->人员附表 处分信息基础页面
    private static final HRBaseServiceHelper HRPI_EMPPROEXP_SERVICE_HELPER = new HRBaseServiceHelper("nckd_hrpi_chufeninfo");

    private EmchufeninfoRepository() {
    }


    public static EmchufeninfoRepository getInstance() {
        return EmchufeninfoRepository.Holder.INSTANCE;
    }
    ...
    private static class Holder {
        static final EmchufeninfoRepository INSTANCE = new EmchufeninfoRepository();
