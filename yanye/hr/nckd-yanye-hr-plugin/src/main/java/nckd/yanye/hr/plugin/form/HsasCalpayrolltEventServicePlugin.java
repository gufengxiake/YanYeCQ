...
public class HsasCalpayrolltEventServicePlugin implements IEventServicePlugin {
    ...
    public void getDynamicObject(DynamicObject hsasApprovebillObject){
        if (Objects.nonNull(hsasApprovebillObject)){
            ...
            //备注赋值
            hsasApprovebillObject.set("description","总人数："+num+"，总薪资合计："+salaryTotal.setScale(2)+"，净薪资合计："+netWorthTotal.setScale(2));
