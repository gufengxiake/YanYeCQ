...
/**
 * HR员工自助移动端-处分信息-弹框
 * 移动动态表单标识：nckd_hspm_chufeninfo_mdg
 * author:chengchaohua
 * date:2024-10-11
 */
public class ChuFenInFoMobEditPlugin extends AbstractMobileFormDrawEdit {

    public ChuFenInFoMobEditPlugin(){}
    ...
    public void beforeBindData(EventObject eventObject) {
        ...
        this.setValueFromDb(this.getView().getFormShowParameter(), "nckd_hrpi_chufeninfo", (String)null);
    ...
    public void click(EventObject evt) {
        ...
        if ("btn_edit".equals(source.getKey())) {
            ...
            if (pkid != null && pkid != 0L) {
                resultMap = this.updateAttachData("nckd_hrpi_chufeninfo", this.getView(), false, (String)null);
            } else {
                resultMap = this.addAttachData("0", "nckd_hrpi_chufeninfo", this.getView(), this.getModel().getDataEntity(), false);
            }
