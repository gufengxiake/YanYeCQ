...
public class EmporgreloutRepository {
    // 核心人力云->人员信息->分类维护表单 系统外任职经历  nckd_hspm_emporgrelout
    private static final HRBaseServiceHelper SERVICE_HELPER = new HRBaseServiceHelper("nckd_hspm_emporgrelout");
    // HR中台服务云->员工信息中心->人员附表 系统外任职经历基础页面 nckd_hrpi_emporgrelout
    private static final HRBaseServiceHelper HRPI_EMPPROEXP_SERVICE_HELPER = new HRBaseServiceHelper("nckd_hrpi_emporgrelout");

    private EmporgreloutRepository() {
    }


    public static EmporgreloutRepository getInstance() {
        return EmporgreloutRepository.Holder.INSTANCE;
    }
    ...
    private static class Holder {
        static final EmporgreloutRepository INSTANCE = new EmporgreloutRepository();
