...
/**
 * HR员工自助移动端-项目经历-弹框
 * 移动动态表单标识：nckd_hspm_empproexp_mdg
 * author:chengchaohua
 * date:2024-08-17
 */
public class EmpproexpMobEditPlugin extends AbstractMobileFormDrawEdit {

    public EmpproexpMobEditPlugin() {}
    ...
    public void beforeBindData(EventObject eventObject) {
        ...
        this.setValueFromDb(this.getView().getFormShowParameter(), "hrpi_empproexp", (String)null);
    ...
    public void click(EventObject evt) {
        ...
        if ("btn_edit".equals(source.getKey())) {
            ...
            if (pkid != null && pkid != 0L) {
                resultMap = this.updateAttachData("hrpi_empproexp", this.getView(), false, (String)null);
            } else {
                resultMap = this.addAttachData("0", "hrpi_empproexp", this.getView(), this.getModel().getDataEntity(), false);
            }
