...
public class PurapplybillConst {
    ...
    /**
     * Type:DynamicObject,sourceEntityId:bd_admindivision,Name:收货地址
     */
    public static final String NCKD_RECEIVEADDR = "nckd_receiveaddr";
