...
public class InforeceivebillConst {
	 ...
	 */
	public static final String NCKD_SUPPLIERNAME = "nckd_suppliername";

	/**
	 * Type:String,Name:社会统一信用代码
	 */
	public static final String NCKD_USCC = "nckd_uscc";
	 ...
	 */
	public static final String NCKD_SUPPLIERID = "nckd_supplierid";
