...
public class OutBoundShipmentsReportPlugin extends AbstractReportListDataPlugin {
    ...
    public DataSet query(ReportQueryParam reportQueryParam, Object o) throws Throwable {
        ...
        DataSet costrecord = QueryServiceHelper.queryDataSet(this.getClass().getName(),
                "cal_costrecord", "id,bookdate,storageorgunit,calbilltype,adminorg,entry,entry.stocktype.id,entry.id entrypk,entry.material.number as nckd_materialnum,entry.material as nckd_material, entry.material.id,entry.material.modelnum as nckd_model" +
        ...
        costrecord = costrecord.groupBy(new String[]{"nckd_materialnum","nckd_material","nckd_model","nckd_lot","nckd_assist","nckd_configuredcode","nckd_tracknumber","nckd_ispresent","nckd_isrework","nckd_baseunit","nckd_unitstandardcost"}).sum("nckd_baseqty").sum("nckd_amount").finish();
        return costrecord;
    }
}
