...
public class CustomerGroupPushOpPlugin extends AbstractOperationServicePlugIn {
    ...
    public void beforeExecuteOperationTransaction(BeforeOperationArgs e) {
        ...
        for (DynamicObject dataEntity : dataEntities) {
            ...
            JSONObject result = HttpRequestUtils.httpPost("http://5zb5775265qa.vicp.fun/api/Business/PushCustomType", bodyJson, accessToken);
            ...
            parmMap.put("nckd_interfaceurl", "http://5zb5775265qa.vicp.fun/api/Business/PushCustomType");
