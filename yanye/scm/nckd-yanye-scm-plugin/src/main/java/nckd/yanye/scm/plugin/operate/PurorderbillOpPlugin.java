 ...
 * @date : 2024/7/16
 */
public class PurorderbillOpPlugin extends AbstractOperationServicePlugIn {
    @Override
    ...
    public void beginOperationTransaction(BeginOperationTransactionArgs e) {
        ...
        DynamicObject[] purcontractArr = BusinessDataServiceHelper.load("conm_purcontract", "id,billno,totalallamount,nckd_totalallamount,nckd_totalallamountrat,billentry.id,billentry.qty,billentry.nckd_qty,billentry.nckd_qtyratio,billentry.amountandtax,billentry.nckd_amount,billentry.nckd_amountratio,billentry.seq", qFilter.toArray());
