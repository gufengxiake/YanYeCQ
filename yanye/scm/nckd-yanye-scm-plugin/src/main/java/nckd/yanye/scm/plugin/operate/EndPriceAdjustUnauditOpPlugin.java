            ...
            for (DynamicObject object : entry) {
                for (DynamicObject dynamicObject : entryentity) {
                    if(StringUtils.equals(object.getString("nckd_billnumber"),dynamicObject.getString("nckd_oddnumber"))){
                        ...
                        pricetaxtotal = pricetaxtotal.add(dynamicObject.getBigDecimal("nckd_oldtotalprice"));
                        amount = amount.add(dynamicObject.getBigDecimal("nckd_oldamount"));
                        tax = tax.add(dynamicObject.getBigDecimal("nckd_odltax"));
                    }
                }
            }
            // 反写金额信息
