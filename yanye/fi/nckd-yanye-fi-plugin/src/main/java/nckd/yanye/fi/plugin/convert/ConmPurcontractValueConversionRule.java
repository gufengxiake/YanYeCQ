 ...
 * @description 采购合同-》合同台账 税率 集成值转换
 */
public class ConmPurcontractValueConversionRule implements JavaValueConversionRule {
    @Override
    public Object cast(String s, ConnectionWrapper connectionWrapper, ConnectionWrapper connectionWrapper1) {
        DynamicObject loadSingle = BusinessDataServiceHelper.loadSingle(s, "conm_purcontract");
