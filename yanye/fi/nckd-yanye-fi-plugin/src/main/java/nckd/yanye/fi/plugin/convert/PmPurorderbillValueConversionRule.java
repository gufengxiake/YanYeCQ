 ...
 * @description 采购订单-》合同台账 税率 集成值转换
 */
public class PmPurorderbillValueConversionRule implements JavaValueConversionRule {
    @Override
    public Object cast(String s, ConnectionWrapper connectionWrapper, ConnectionWrapper connectionWrapper1) {
        DynamicObject loadSingle = BusinessDataServiceHelper.loadSingle(s, "pm_purorderbill");
